document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const siblingError = field.parentNode
  ...
  if (animatableElements.length > 0) {
    ...
    animatableElements.forEach(function (el, index) {
      ...
      } else if (el.hasAttribute('data-stagger-index')) {
        const staggerIndex = parseInt(el.getAttribute('data-stagger-index'), 10);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לביא אתר משחקים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd10ea279-5902-45a1-a0b6-01b9aeb55d07',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd10ea279-5902-45a1-a0b6-01b9aeb55d07';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd10ea279-5902-45a1-a0b6-01b9aeb55d07';
